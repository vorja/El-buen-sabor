...
<body class="bg-[#F5E6D3] font-sans">
  <!-- Navbar -->
  <nav class="bg-[#4A3428] text-white shadow-lg fixed w-full z-10">
    <div class="container mx-auto px-4">
      ...
      <div class="navbar flex space-x-1 md:space-x-4 py-2 overflow-x-auto">
        <a href="./dashboard.php" class="nav-btn px-3 md:px-4 py-2 rounded-lg  hover:bg-blue-600 font-medium transition-colors" data-section="inventario">
    ...
    <!-- Inventario Section -->
    <section id="inventario" class="section active pt-32 px-4">
      <div class="container mx-auto">
        <div class="flex justify-between items-center mb-6">
          <h2 class="text-2xl font-bold text-gray-800">Inventario</h2>
          <div class="flex space-x-2">
            <button class=" text-white px-4 py-2 rounded-lg transition-colors">
