    ...
    <div class="row justify-content-center">
      <div class="col-12 col-sm-10 col-md-8 col-lg-6 col-xl-5">
        ...
        <div class="mb-3">
              ...
              <input type="text" class="form-control" id="Cedula" required placeholder="Tu cedula">
        ...
        <div class="mb-3">
              ...
              <input type="text" class="form-control" id="name" required placeholder="Tu nombre completo">
              <div class="invalid-feedback">
            ...
            <div class="mb-3">
              ...
              <input type="tel" class="form-control" id="phone" required placeholder="Tu número de teléfono">
              <div class="invalid-feedback">
